...
List<FeaturedModel> featuredFromJson(String str) => List<FeaturedModel>.from(
    json.decode(str).map((x) => FeaturedModel.fromJson(x)));

String welcomeToJson(List<FeaturedModel> data) =>
